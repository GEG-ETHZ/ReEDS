...
The co2_storage_supplycurve_baseline.csv file is an example of the supply curves that were implemented in GAMS (this is the file referenced in b_inputs). 
This file was created using the supply curve data in the sco2t_supply_curve_data.xlsx file. The raw data was not used directly to somewhat reduce the number of bins.
